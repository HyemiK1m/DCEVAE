...
parser.add_argument('--beta2', type=float, default=1, help='beta2')
...
model = CVAE(args, sens_dim=sens_dim, rest_dim=rest_dim, des_dim=des_dim, u_dim=args.u_dim).to(args.device)
model = model.train()
